...
TRANSLATIONS = {
    ...
    "connect_local_note": {
        "de": "Das ist die lokale Adresse des Containers. Für Freunde aus dem Internet die öffentliche IP/DDNS bei den Startparametern eintragen und die Ports in OPNsense weiterleiten.",
        "en": "This is the container's local address. For friends over the internet, set the public IP/DDNS in the launch parameters and forward the ports in your firewall.",
    },
