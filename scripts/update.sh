...
install -m 0755 "$REPO_DIR/src/ark-mods.py" /home/ark/ark-mods.py
chown -R "$ARK_USER":"$ARK_USER" "$PANEL_DIR" /home/ark/ark-launch.sh /home/ark/ark-update.sh /home/ark/ark-mods.py
